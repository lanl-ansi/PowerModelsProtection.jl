...
function parse_opendss(file::String; method::Union{String,Missing}=missing, kwargs...)
    pm_data = _PMD.parse_file(file; dss2eng_extensions=[_dss2eng_solar_dynamics!, _dss2eng_load_dynamics!, _dss2eng_gen_dynamics!, _dss2eng_voltage_source_dynamics!, _dss2eng_transformer_dynamics!, _dss2eng_transformers!, _dss2eng_issues!], kwargs...)
    if ismissing(method)
        pm_data["method"] = "PMD"
    else
