@testset "unbalance fault study" begin
    ...
    #     v_i = result["loadbus"]["3p"][1]["solution"]["bus"]["pv_bus"]["vi"]
    #     v = v_r + 1im*v_i
    #     @test isapprox(abs(v[1]), 0.0277888; atol = 0.01)
    ...
    #     v = v_r + 1im*v_i
    #     @test isapprox(abs(v[1]), 0.0279377; atol = 0.01)
    ...
    #     v = v_r + 1im*v_i
    #     @test isapprox(abs(v[1]), 0.03333; atol = 0.002)
    #     @test isapprox(abs(v[2]), 0.03091179; atol = 0.002)
    #     @test isapprox(abs(v[3]), 1.0; atol = 0.002)
    ...
    #     v = v_r + 1im*v_i
    #     @test isapprox(abs(v[1]), 0.0313028; atol = 0.002)
    #     @test isapprox(abs(v[2]), 0.0313028; atol = 0.002)
    #     @test isapprox(abs(v[3]), 1.0; atol = 0.002)
