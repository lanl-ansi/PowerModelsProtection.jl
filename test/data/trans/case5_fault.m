...
mpc.bus = [
	...
	3	 1	 300.0	 98.61	 0.0	 0.0	 1	    1.00000	   -0.55972	 230.0	 1	    1.10000	    0.90000;
...
mpc.branch = [
	...
	3	 4	 0.00297	 0.0297	 0.0000		 426	 426	 426	 1.05	  1.0	 1	 -30.0	 30.0;
	3	 4	 0.00297	 0.0297	 0.00000	 426	 426	 426	 1.05	 -1.0	 1	 -30.0	 30.0;
	4	 10	 0.00297	 0.0297	 0.00674	 240.0	 240.0	 240.0	 0.0	  0.0	 1	 -30.0	 30.0;
];

%% branch fault data
%column_name%	tap	shift
mp.branch_fault = [
	1.00	 0
	1.00	 0
	1.00	 0
