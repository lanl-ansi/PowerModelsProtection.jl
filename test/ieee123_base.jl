...
@testset "test iee123 fault base case" begin
    ...
    @testset "faults on bus 13 base" begin
        ...
        @debug "$("Bus: 13 Fault: 3p ---- ", sol["13"]["3p"]["1"]["solution"]["fault"]["bus"]["current"][1])"
        ...
        @debug "$("Bus: 13 Fault: ll ---- ", sol["13"]["ll"]["1"]["solution"]["fault"]["bus"]["current"][1])"
        ...
        @debug "$("Bus: 13 Fault: lg ---- ", sol["13"]["lg"]["1"]["solution"]["fault"]["bus"]["current"][1])"
    ...
    @testset "faults on bus 67 base" begin
        ...
        @debug "$("Bus: 67 Fault: 3p ---- ", sol["67"]["3p"]["1"]["solution"]["fault"]["bus"]["current"][1])"
        ...
        @debug "$("Bus: 67 Fault: ll ---- ", sol["67"]["ll"]["1"]["solution"]["fault"]["bus"]["current"][1])"
        ...
        @debug "$("Bus: 67 Fault: lg ---- ", sol["67"]["lg"]["1"]["solution"]["fault"]["bus"]["current"][1])"
    ...
    @testset "faults on bus 113 base" begin
        ...
        @debug "$("Bus: 113 Fault: lg ---- ", sol["113"]["lg"]["1"]["solution"]["fault"]["bus"]["current"][1])"
